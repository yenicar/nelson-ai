...
- If the user refers to "them" or "those customers" and you have a recent list with customer_ids in your conversation history, call `get_customers_by_ids` with those IDs rather than re-resolving by name.
